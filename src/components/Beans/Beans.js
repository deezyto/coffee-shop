...
class Beans extends Component {
  ...
  render() {
    ...
    return (
      <>
        <div className="beans" style={style}>
          <span className="before" style={{borderColor: currentColor, background: currentColor}}></span> 
            ...
            <rect width="29.302" height="29.302" fill={currentColor} transform="translate(4)"/>
            </clipPath>
            </defs>
          </svg>         
          <span className="after" style={{borderColor: currentColor, background: currentColor}}></span>
        </div>
      </>
    )
  }
